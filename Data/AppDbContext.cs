...
public class AppDbContext : DbContext
{
    ...
    public DbSet<NaderProductsApp.Models.ControlPanel.CpAdminUser> CpAdminUsers => Set<NaderProductsApp.Models.ControlPanel.CpAdminUser>();
    public DbSet<NaderProductsApp.Models.ControlPanel.CpAdminSession> CpAdminSessions => Set<NaderProductsApp.Models.ControlPanel.CpAdminSession>();
    public DbSet<NaderProductsApp.Models.ControlPanel.CpPlan> CpPlans => Set<NaderProductsApp.Models.ControlPanel.CpPlan>();
    public DbSet<NaderProductsApp.Models.ControlPanel.CpTenant> CpTenants => Set<NaderProductsApp.Models.ControlPanel.CpTenant>();
public DbSet<NaderProductsApp.Models.Employee> Employees => Set<NaderProductsApp.Models.Employee>();
    public DbSet<NaderProductsApp.Models.EmployeeSession> EmployeeSessions => Set<NaderProductsApp.Models.EmployeeSession>();
...
protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        // CONTROL_PANEL_MODEL_CONFIG
        modelBuilder.Entity<NaderProductsApp.Models.ControlPanel.CpAdminUser>(e =>
        {
            e.HasIndex(x => x.Username).IsUnique();
        });

        modelBuilder.Entity<NaderProductsApp.Models.ControlPanel.CpAdminSession>(e =>
        {
            e.HasIndex(x => x.Token).IsUnique();
            e.HasIndex(x => x.AdminUserId);
        });

        modelBuilder.Entity<NaderProductsApp.Models.ControlPanel.CpPlan>(e =>
        {
            e.HasIndex(x => x.Code).IsUnique();
            e.Property(x => x.PriceMonthly).HasColumnType("numeric(18,2)");
        });

        modelBuilder.Entity<NaderProductsApp.Models.ControlPanel.CpTenant>(e =>
        {
        ...
        modelBuilder.Entity<NaderProductsApp.Models.Employee>(e =>
        {
            e.HasIndex(x => x.Username).IsUnique();
            e.Property(x => x.Permissions).HasColumnType("bigint");
        });

        modelBuilder.Entity<NaderProductsApp.Models.EmployeeSession>(e =>
        {
            e.HasIndex(x => x.Token).IsUnique();
