...
builder.Services.AddDbContext<NaderProductsApp.Data.AppDbContext>(o => o.UseNpgsql(builder.Configuration.GetConnectionString("Default")));
...
// ======================= PRODUCTS =======================
app.MapGet("/api/products", async ([FromServices] NaderProductsApp.Data.AppDbContext db) =>
    Results.Ok(await db.Products.OrderByDescending(x => x.Id).ToListAsync()));

app.MapGet("/api/products/cashier", async ([FromServices] NaderProductsApp.Data.AppDbContext db) =>
{
...
app.MapPost("/api/products", async ([FromServices] NaderProductsApp.Data.AppDbContext db, Product input) =>
{
...
app.MapPut("/api/products/{id:int}", async ([FromServices] NaderProductsApp.Data.AppDbContext db, int id, Product input) =>
{
...
app.MapDelete("/api/products/{id:int}", async ([FromServices] NaderProductsApp.Data.AppDbContext db, int id) =>
{
    var p = await db.Products.FindAsync(id);
    if (p is null) return Results.NotFound();
...
// ======================= CASHIER =======================
app.MapPost("/api/cashier/invoices", async (HttpRequest http, [FromServices] NaderProductsApp.Data.AppDbContext db, CashierInvoiceRequest req) =>
{
...
app.MapGet("/api/cashier/invoices/{id:int}", async ([FromServices] NaderProductsApp.Data.AppDbContext db, int id) =>
{
...
app.MapGet("/api/cashier/invoices/{id:int}/items", async ([FromServices] NaderProductsApp.Data.AppDbContext db, int id) =>
{
    var inv = await db.CashierInvoices.AsNoTracking().FirstOrDefaultAsync(x => x.Id == id);
    if (inv is null) return Results.NotFound();
...
app.MapGet("/api/cashier/invoices/report", async ([FromServices] NaderProductsApp.Data.AppDbContext db,
...
app.MapPost("/api/cashier/invoices/{id:int}/return", async ([FromServices] NaderProductsApp.Data.AppDbContext db, int id, ReturnRequest req) =>
{
...
app.MapDelete("/api/cashier/invoices/{id:int}", async ([FromServices] NaderProductsApp.Data.AppDbContext db, int id) =>
{
    var inv = await db.CashierInvoices.Include(x => x.Items).FirstOrDefaultAsync(x => x.Id == id);
    if (inv is null) return Results.NotFound();
...
app.MapGet("/api/customers/full", async ([FromServices] NaderProductsApp.Data.AppDbContext db) =>
{
...
app.MapPost("/api/customers", async ([FromServices] NaderProductsApp.Data.AppDbContext db, Customer input) =>
{
    input.Name = (input.Name ?? "").Trim();
...
app.MapPut("/api/customers/{id:int}", async ([FromServices] NaderProductsApp.Data.AppDbContext db, int id, Customer input) =>
{
...
app.MapDelete("/api/customers/{id:int}", async ([FromServices] NaderProductsApp.Data.AppDbContext db, int id) =>
{
...
app.MapPut("/api/customer-payments/{id:int}", async ([FromServices] NaderProductsApp.Data.AppDbContext db, int id, CustomerPaymentRequest req) =>
{
...
app.MapDelete("/api/customer-payments/{id:int}", async ([FromServices] NaderProductsApp.Data.AppDbContext db, int id) =>
{
    var p = await db.CustomerPayments.FindAsync(id);
    if (p is null) return Results.NotFound();
...
app.MapPost("/api/customers/{id:int}/invoices", async ([FromServices] NaderProductsApp.Data.AppDbContext db, int id, CustomerLedgerRequest req) =>
{
    var c = await db.Customers.FindAsync(id);
    if (c is null) return Results.NotFound();
...
app.MapPost("/api/customers/{id:int}/payments", async ([FromServices] NaderProductsApp.Data.AppDbContext db, int id, CustomerPaymentRequest req) =>
{
    var c = await db.Customers.FindAsync(id);
    if (c is null) return Results.NotFound();
...
// EXPENSES_API_V1
//
app.MapGet("/api/expenses", async (NaderProductsApp.Data.AppDbContext db,
    string? q,
    DateTime? fromDate,
    DateTime? toDate,
    decimal? minAmount,
...
app.MapPost("/api/expenses", async (NaderProductsApp.Data.AppDbContext db, NaderProductsApp.Models.Expense body) =>
{
...
app.MapPut("/api/expenses/{id:int}", async (NaderProductsApp.Data.AppDbContext db, int id, NaderProductsApp.Models.Expense body) =>
{
...
app.MapDelete("/api/expenses/{id:int}", async (NaderProductsApp.Data.AppDbContext db, int id) =>
{
    var e = await db.Expenses.FindAsync(id);
    if (e is null) return Results.NotFound();
